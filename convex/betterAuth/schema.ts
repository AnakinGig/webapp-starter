 ...
 *
 * Based on the schema generated by `npx auth generate`, extended with the
 * app's custom `user.role` field (mirrors the `user.additionalFields.role`
 * declaration in auth.ts - keep both in sync).
 */
