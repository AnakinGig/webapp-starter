...
- [ ] **Security notifications** - email the account owner when the password is changed or the account is deleted (a stolen-session safety net; reuse `convex/email.ts`)
